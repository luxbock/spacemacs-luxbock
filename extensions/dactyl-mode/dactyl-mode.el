...
(defcustom dactyl-tab-width tab-width
  "The tab width to use when indenting."
  :type 'integer
  :group 'dactyl-mode
  :safe 'integerp)

(defcustom dactyl-indent-tabs-mode nil
...
(defvar dactyl-font-lock-keywords
  `(
    ...
    ;; Display urls outside strings with default font
...
;;;###autoload
(add-to-list 'auto-mode-alist '("[._]?g?dactyl\\'" . dactyl-mode))
